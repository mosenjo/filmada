...
const footerInner = document.querySelector("footer .footer");
if (footerInner && !footerInner.querySelector("[data-maker-credit]")) {
  const language = document.documentElement.lang === "fr" ? "fr" : "en";
  const credit = document.createElement("p");
  const link = document.createElement("a");

  credit.className = "maker-credit";
  credit.setAttribute("data-maker-credit", "");
  credit.append(document.createTextNode(language === "fr" ? "Confectionné avec ❤️ par " : "Made with ❤️ by "));
